...
- برای توضیحات پروژهٔ اول، بالای هر خط کد توضیحاتش رو نوشتم.یه پوشه هم با نام (کدها) درون فایل پروژه قرار گرفته شده که کد های پروژه رو مرتب کردم و درون پوشه قرار دادم.
